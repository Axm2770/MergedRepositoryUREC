...
public class League {
    ...
    public void addDivision(Division div)   { this.divisions.add(div); }
            ...
            try {
                ...
                while (reader.hasNextLine())    {
                    ...
                    while (data.compareTo("-") != 0)    {
                        ...
                        divName = data;
                        data = reader.nextLine();
                        if (data.compareTo("1") == 0) { divWaitList = true; }
                        else { divWaitList = false; }
                        data = reader.nextLine();
                        if (data.compareTo("1") == 0) { divMaleness = true; }
                        ...
                        data = reader.nextLine();
                        if (data.compareTo("1") == 0) { divFailToAdd = true; }
